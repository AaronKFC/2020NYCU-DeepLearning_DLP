...
int main(int argc, const char* argv[]) {
	...
	// tdl.load("C:\\Users\\AllenPC\\AllenTest\\DLP\\Lab7\\2018_DLP_lab5\\lab5_code\\model_afterstate.pth");
	...
	fstream rewardlog;
	rewardlog.open("C:\\Users\\AllenPC\\AllenTest\\DLP\\Lab7\\2018_DLP_lab5\\lab5_code\\rewardlog_state.csv",ios::out);
	// rewardlog.open("C:\\Users\\AllenPC\\AllenTest\\DLP\\Lab7\\2018_DLP_lab5\\lab5_code\\rewardlog_afterstate.csv",ios::out);
	...
	for (size_t n = 1; n <= total; n++) {
		...
		while (true) {
			...
			state best = tdl.select_best_move_state(b);
		...
		if(n%1000==0)
			rewardlog << n << "," << mean << endl;
	}

	// store the model into file
	tdl.save("C:\\Users\\AllenPC\\AllenTest\\DLP\\Lab7\\2018_DLP_lab5\\lab5_code\\model_state.pth");
	// tdl.save("C:\\Users\\AllenPC\\AllenTest\\DLP\\Lab7\\2018_DLP_lab5\\lab5_code\\model_afterstate.pth");
	rewardlog.close();
